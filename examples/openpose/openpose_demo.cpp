...
DEFINE_int32(port,			-1,		"port to listen");
DEFINE_int32(keypoint_port,		-1,		"port to send the pose data");
DEFINE_bool(read_keypoint_json,		false,		"read the keypoint information");
DEFINE_bool(read_keypoint_json_socket,  false,		"read the keypoint information and send back by socket. Not the same port as the image transport!");
