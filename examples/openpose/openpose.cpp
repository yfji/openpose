...
DEFINE_int32(port,			9010,		"port to listen");
DEFINE_int32(keypoint_port,			9012,		"port to send the pose data");
...
int openPoseDemo()
{
    ...
    const op::WrapperReader wrapperReader{FLAGS_server_address, FLAGS_keypoint_port, FLAGS_read_keypoint_json, FLAGS_read_keypoint_json_socket};
    // Configure wrapper
