...
namespace op
{
    ...
    OP_API ProducerType flagsToProducerType2(const std::string& imageDirectory, const std::string& videoPath,
                                            const std::string& ipCameraPath, const int webcamIndex,
					    const std::string &ip);
    ...
    OP_API std::shared_ptr<Producer> flagsToProducer2(const std::string& imageDirectory, const std::string& videoPath,
                                                     const std::string& ipCameraPath, const int webcamIndex,
                                                     const std::string& webcamResolution = "1280x720",
                                                     const double webcamFps = 30., const std::string& ip="10.106.18.20", const int port=76543);
